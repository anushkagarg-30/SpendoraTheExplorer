...
export default function HomePage() {
  ...
  const monthlyCoffee = ((budgetData.coffee_per_week || 5) as number) * ((budgetData.coffee_cost || 6) as number) * 4
  const monthlyShopping = budgetData.shopping_monthly || 80
  const monthlyRent = budgetData.rent || 1200
  const monthlyUtilities = ((budgetData.wifi || 30) as number) + ((budgetData.electricity || 25) as number)
  ...
  // Calculate month stats for Violet Coach
  ...
  const monthStats = {
    ...
    daysPassed,
    daysRemaining,
    groceriesSpent: spentGroceries,
    eatingOutSpent: spentEatingOut,
    coffeeSpent: spentCoffee,
    transportSpent: spentTransport,
    shoppingSpent: 0,
  }
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-primary to-dark-purple text-white py-4 px-6 rounded-xl font-bold hover:opacity-90 transition-all shadow-lg hover:shadow-xl text-lg flex items-center justify-center gap-2"
            >
